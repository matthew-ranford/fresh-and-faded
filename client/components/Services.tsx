                ...
                <Accordion defaultActiveKey="14">
                  ...
                  <Accordion.Item eventKey="16">
                    ...
                    <Accordion.Body>
                      ...
                      excitement to get the cut done hopefully. We all know how
                      toddlers can be!
                    </Accordion.Body>
                    <Accordion.Body>
                      We supply toy ride on cars and motorbikes for the kids to
                      play on and also kids channels on sky to keep them
                      occupied. (phone or iPad also good to keep kids occupied)
                      We have young kids of our own so we know how it goes with
                      kids 😊
                    </Accordion.Body>
                  </Accordion.Item>
